...
self.addEventListener('fetch', event => {
  ...
  // Network-first for page navigations (the app shell) so updates show up
  // right away instead of being stuck on an old cached version forever.
  ...
  // Cache-first for everything else (icons, sounds, etc.)
  event.respondWith(
